...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({post:e})=>V.jsxs("div",{className:"PostInfo",children:[V.jsxs("div",{className:"PostInfo__header",children:[V.jsx("h3",{className:"PostInfo__title",children:e.title}),V.jsxs("p",{children:[" Posted by  ",V.jsx("a",{className:"UserInfo",href:`mailto:${e.user.email}`,children:e.user.name})]})]}),V.jsx("p",{className:"PostInfo__body",children:e.body}),V.jsx("hr",{}),e.comments.length===0?V.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):V.jsx("div",{className:"CommentList",children:e.comments.map(t=>V.jsxs("div",{className:"CommentInfo",children:[V.jsxs("div",{className:"CommentInfo__title",children:[V.jsx("strong",{className:"CommentInfo__name",children:t.name})," by ",V.jsx("a",{className:"CommentInfo__email",href:`mailto:${t.email}`,children:t.email})]}),V.jsx("div",{className:"CommentInfo__body",children:t.body})]},t.id))})]}),Lc=({posts:e})=>V.jsx("div",{className:"PostList",children:e.map(t=>V.jsx(Pc,{post:t},t.id))}),Tc=Cc.map(e=>({...e,user:zc.find(t=>t.id===e.userId),comments:Nc.filter(t=>t.postId===e.id)})),Mc=()=>V.jsxs("section",{className:"App",children:[V.jsx("h1",{className:"App__title",children:"Static list of posts"}),V.jsx(Lc,{posts:Tc})]});em(document.getElementById("root")).render(V.jsx(Mc,{}));
